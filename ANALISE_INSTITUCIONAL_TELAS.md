...
<strong>Data:</strong> 19 de agosto de 2026
</p>
...
| Governar | Manutenção, ACL, Ghost, igrejas, billing | Controle institucional com rastreio |
...
É o corredor interno da plataforma. Na parte de cima, a vida do membro (Início, Perfil, Financeiro, Escalas, Aniversariantes, Lista de Membros, Administrativo). Depois da linha, a operação da igreja (eventos, salas, escalas, pastoral, finanças, relatórios, papéis, Ghost). A engrenagem abre configurações finas: trilha, salas, avisos, igrejas, assinaturas e autorização de imagem.
...
Catálogo da manutenção. Papéis pastoral/super admin conforme o relatório.
...
Pastoral e super admin. Integra-se à Lista de Membros, carteirinha (status) e limites de billing.
...
5. A equipe **governa** (ACL, papéis, Ghost, relatórios, tesouraria).
