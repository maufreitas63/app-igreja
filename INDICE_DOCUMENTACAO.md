...
| Documento | Markdown | PDF / Word | Público |
|-----------|----------|------------|---------|
...
| **Análise institucional de telas** | [`ANALISE_INSTITUCIONAL_TELAS.md`](ANALISE_INSTITUCIONAL_TELAS.md) | [`PDF`](pdfs/ANALISE_INSTITUCIONAL_TELAS.pdf) · [`DOCX`](pdfs/ANALISE_INSTITUCIONAL_TELAS.docx) · [`DOC`](pdfs/ANALISE_INSTITUCIONAL_TELAS.doc) | Liderança e comercial · atualizado em 28/08/2026 |
