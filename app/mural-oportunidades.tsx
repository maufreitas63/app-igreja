...
export default function MuralOportunidadesScreen() {
  ...
  const accessStatus = useDashboardCardRouteAccess({
    resourceKey: ACCESS_DASHBOARD_CARD.opportunities,
    deniedMessage: 'Você não tem permissão para abrir o Mural de Oportunidades.',
    ...
    <ScreenAccessGate status={accessStatus}>
      <MinimalScreenLayout scroll={false} footer={<CloseFooterBar onPress={returnToCaller} />}>
        <View style={styles.stage}>
          <OpportunityMuralCard panelHeight={panelHeight} isActive />
        </View>
      </MinimalScreenLayout>
    </ScreenAccessGate>
  );
