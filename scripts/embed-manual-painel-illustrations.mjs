...
const anchors = [
  ...
  { after: '### Caminho (visitantes)\nLista de Membros → toque **Visitantes**.', image: '08c-lista-visitantes.png', title: 'Lista de Visitantes' },
  { after: '### Caminho (modal familiar)\nLista de Membros → coluna **Família** → ícone **users** na linha desejada.', image: '08b-lista-membros-familia.png', title: 'Membros da família (modal)' },
  { after: '### Caminho (mapa)\nLista de Membros → **Mapa Geral**.', image: '08d-mapa-geral.png', title: 'Mapa Geral' },
