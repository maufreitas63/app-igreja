-- Corrige registrar_escala_manual para respeitar vagas_por_servico (múltiplos servos no mesmo domingo).
-- Execute no Supabase após access-control-lider-escala.sql e escalas-multi-vagas.sql.
