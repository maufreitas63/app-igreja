...
const hasTreasuryReceiptImageExtension = (fileName) => {
  const lower = fileName.toLowerCase();

  return lower.endsWith('.jpeg') || lower.endsWith('.jpg');
};

const stripTreasuryReceiptImageExtension = (fileName) => {
  const lower = fileName.toLowerCase();
...
const buildTreasuryReceiptCanonicalFileName = (referenciaBase, position) =>
  position !== null
