// CONGELADO — não importar este arquivo (Metro não deve carregá-lo).
// Cópia comentada de app/(tabs)/dashboard.tsx no congelamento dos cards fora do caminho vivo.
// Ver lib/frozenPublication.ts. Para descongelar, restaure trechos daqui para o dashboard vivo.
//
